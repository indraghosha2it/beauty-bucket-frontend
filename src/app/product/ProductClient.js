...
const handleBuyNow = async () => {
  ...
  <div className="sticky top-20 lg:top-24">
    ...
    {/* Main Image - Right side - FIXED to fill container */}
<div className="flex-1 order-1 sm:order-2 relative">
  ...
  >
    {/* REMOVED pt-[100%] - using flex to fill container instead */}
        ...
        {!isMainVideo && mainImage ? (
          <>
            <img
              ...
              // CHANGED: object-cover instead of object-contain to fill container
...
<div className="relative overflow-hidden">
  ...
  style={{
    width: `calc((100% - ${(carouselItemsPerView - 1) * 16}px) / ${carouselItemsPerView})`
  }}
>
              <RelatedProductCard 
                product={relProduct} 
