...
// // Section type options - These are system sections (no delete)
// const SYSTEM_SECTION_TYPES = [
//   { value: 'hero', label: 'Hero Banner', icon: LayoutTemplate, deletable: false, hasProducts: false },
//   { value: 'brands', label: 'Brands Scroll', icon: Grid3x3, deletable: false, hasProducts: false },
...
//   { value: 'carousel', label: 'Carousel', icon: Car },
...
//               Showing: <span className="font-medium text-[#004767]">{products.length}</span> products
//             </p>
//             <p className="text-xs text-gray-400">
//               Selected: <span className="font-medium text-[#06B6D4]">{selectedProductIds.length}</span> products
//             </p>
//           </div>
//         </div>
...
//                       isSelected
//                         ? 'border-[#06B6D4] bg-[#06B6D4]/5 ring-1 ring-[#06B6D4]/30'
...
//             Are you sure you want to delete <strong className="text-[#06B6D4]">"{sectionName}"</strong>? This action cannot be undone.
//           </p>
...
//     console.log(`🔄 Toggling ${section.name}: ${section.isActive} -> ${newStatus}`);
...
//             <TypeIcon className={`w-4 h-4 ${section.isActive ? 'text-[#06B6D4]' : 'text-gray-400'}`} />
//             <input
//               type="text"
//               value={section.name}
//               onChange={(e) => onUpdate(index, { ...section, name: e.target.value })}
//               placeholder="Section Name"
//               className={`px-2 py-1 text-sm font-medium border rounded bg-white focus:ring-2 focus:ring-[#06B6D4] focus:border-transparent outline-none ${
...
//                   });
//                 }}
//                 className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-[#06B6D4] focus:border-transparent outline-none transition bg-white ${
//                   section.isActive ? 'border-[#06B6D4]/20' : 'border-gray-200'
//                 }`}
//               >
...
//               section.isActive ? 'bg-gray-50 border-[#06B6D4]/20' : 'bg-gray-100 border-gray-200'
//             }`}>
//               <div>
//                 <label className="block text-xs font-medium text-gray-700 mb-1">
//                   Custom Title
...
//                   className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#06B6D4] border border-[#06B6D4]/20 rounded-lg hover:bg-[#06B6D4]/10 transition-colors"
//                 >
...
//                     type="button"
//                     onClick={() => setIsProductSearchOpen(true)}
//                     className="mt-2 text-[#06B6D4] hover:text-[#0891B2] font-medium text-sm"
//                   >
//                     + Add Products
//                   </button>
//                 </div>
...
//                 <span className="font-medium text-[#004767]">System Section:</span> This is a system section. 
...
// //   try {
// //     const token = localStorage.getItem('token');
// //     // ✅ Use the new /all endpoint that forces all sections
// //     const response = await fetch('http://localhost:5000/api/admin/homepage/all', {
// //       headers: { 'Authorization': `Bearer ${token}` }
// //     });
...
//       ...updatedSection,
//       // Preserve the exact isActive value
...
//   //     // Include ALL sections, preserve their isActive values
...
//   //     // Log which sections are inactive
//   //     const inactiveSections = sectionsWithOrder.filter(s => s.isActive === false);
//   //     console.log('🔍 INACTIVE SECTIONS:', inactiveSections.map(s => s.name));
//   //     console.log('🔍 SENDING DATA (ALL sections):', sectionsWithOrder.map(s => ({
//   //       name: s.name,
//   //       isActive: s.isActive
//   //     })));
...
//   //     try {
//   //       const token = localStorage.getItem('token');
//   //       const response = await fetch('http://localhost:5000/api/admin/homepage/reset', {
//   //         method: 'POST',
//   //         headers: { 'Authorization': `Bearer ${token}` }
//   //       });
//   //       const data = await response.json();
...
//                     <LayoutTemplate className="w-5 h-5 sm:w-6 sm:h-6 text-[#06B6D4]" />
...
//                   <LayoutTemplate className="w-5 h-5 text-[#06B6D4]" />
//                   Homepage Sections
...
//                 <LayoutTemplate className="w-12 h-12 mx-auto mb-3 text-[#06B6D4]/30" />
