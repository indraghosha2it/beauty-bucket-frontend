...
//               <a href="/authorize/dashboard" className="p-1.5 sm:p-2 hover:bg-pink-600/20 rounded-lg transition-colors flex-shrink-0">
...
//                     <Battery className="w-5 h-5 sm:w-6 sm:h-6 text-pink-600" />
//                     Category Management
//                   </h1>
//                 </div>
...
//               <div className="text-xs sm:text-sm text-black/70 bg-pink-600/10 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg border border-pink-600/20">
//                 Total: <span className="font-semibold text-pink-600">{categories.length}</span> categories
//               </div>
//               <button onClick={fetchCategories} className="p-1.5 sm:p-2 text-pink-600 hover:bg-pink-600/20 rounded-lg transition-colors hover:text-blue-800" title="Refresh">
...
//             <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-pink-600/20 sticky top-24">
//               <div className="p-5 border-b border-pink-600/20 bg-gradient-to-r from-pink-600/5 to-[#004767]/5">
...
//                           imageError ? 'border-red-300 bg-red-50' : errors.image ? 'border-red-300 bg-red-50' : 'border-pink-600/30 hover:border-pink-600 hover:bg-pink-600/5'
//                         }`}
//                         onClick={() => {
//                           setImageError('');
...
//                         />
//                         <Upload className={`w-8 h-8 mx-auto mb-2 ${imageError || errors.image ? 'text-red-400' : 'text-pink-600'}`} />
...
//                       <div className="relative rounded-lg overflow-hidden border border-pink-600/20">
...
//                     className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-pink-600 focus:border-transparent outline-none transition ${
//                       errors.name ? 'border-red-500' : 'border-pink-600/30'
//                     } bg-white hover:border-pink-600/50`}
...
//     rows="3"
//     className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-pink-600 focus:border-transparent outline-none transition ${
//       errors.description ? 'border-red-500' : 'border-pink-600/30'  // ← Remove this error check
//     } bg-white hover:border-pink-600/50`}
...
//                   className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-pink-600 hover:bg-pink-700/90 text-white font-medium rounded-lg hover:opacity-90 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm shadow-md hover:shadow-lg hover:shadow-pink-600/20"
//                 >
//                   {isSubmitting ? (
//                     <>
...
//                       className="w-full pl-10 pr-4 py-2 text-sm border border-pink-600/20 rounded-lg focus:ring-2 focus:ring-pink-600 focus:border-transparent outline-none transition placeholder:text-gray-400 bg-white hover:border-pink-600/40"
//                     />
//                   </div>
//                 </div>
//               </div>
...
//                           <FolderTree className="w-3.5 h-3.5 text-pink-600" />
//                           SubCategories
//                         </div>
//                       </th>
//                       <th className="px-5 py-3 text-left text-xs font-medium text-[#64748B] uppercase tracking-wider">
...
//                           <Loader2 className="w-6 h-6 animate-spin mx-auto text-pink-600" />
//                         </td>
//                       </tr>
...
//                         <tr key={category._id} className="hover:bg-pink-600/5 transition-colors">
//                           <td className="px-5 py-3">
//                             <div className="w-12 h-12 rounded-lg overflow-hidden border border-pink-600/20">
//                               <img 
...
//                               className="flex items-center gap-1.5 px-2 py-1 bg-pink-600/10 text-pink-600 rounded-lg hover:bg-pink-600/20 transition-colors text-xs font-medium border border-pink-600/20"
//                             >
...
//                               <button onClick={() => handleViewClick(category)} className="p-1.5 text-gray-600 hover:text-pink-600 hover:bg-pink-600/10 rounded-lg transition-colors" title="View Details">
...
//                               </button>
//                               <button onClick={() => handleEditClick(category)} className="p-1.5 text-gray-600 hover:text-pink-600 hover:bg-pink-600/10 rounded-lg transition-colors" title="Edit">
...
//                                       <Info className="w-3.5 h-3.5 flex-shrink-0 mt-0.5 text-pink-600" />
...
//                 </table>
//               </div>
//               <div className="px-5 py-3 border-t border-pink-600/20 bg-gradient-to-r from-pink-600/5 to-[#004767]/5">
...
//           <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 overflow-hidden max-h-[90vh] overflow-y-auto border border-pink-600/20">
//             <div className="flex items-center justify-between px-6 py-4 border-b border-pink-600/20 sticky top-0 bg-white/80 backdrop-blur-sm z-10">
//               <div className="flex items-center gap-3">
//                 <div className="w-10 h-10 rounded-lg overflow-hidden border border-pink-600/20">
//                   <img 
...
//                 </div>
//               </div>
//               <button onClick={handleViewClose} className="p-1.5 hover:bg-pink-600/10 rounded-lg transition-colors">
...
//                 <div className="bg-gradient-to-r from-pink-600/5 to-[#004767]/5 rounded-lg p-3 border border-pink-600/20">
...
//                     className="w-full flex items-center justify-between px-3 py-2 bg-pink-600/10 hover:bg-pink-600/20 rounded-lg transition-colors group border border-pink-600/20"
//                   >
//                     <div className="flex items-center gap-2">
...
//                       </span>
//                     </div>
//                     <ChevronRight className={`w-4 h-4 text-pink-600 transition-transform duration-200 ${expandedSubcategories ? 'rotate-90' : ''}`} />
//                   </button>
                  
//                   {expandedSubcategories && (
//                     <div className="mt-3 pt-3 border-t border-pink-600/20">
...
//                             <div key={sub._id} className="flex items-center justify-between p-2 bg-white rounded-lg border border-pink-600/20 hover:shadow-sm transition-shadow">
...
//                                   }}
//                                   className="p-1 text-gray-400 hover:text-pink-600 hover:bg-pink-600/10 rounded transition-colors"
...
//                 <div className="col-span-2 bg-gradient-to-r from-pink-600/5 to-[#004767]/5 rounded-lg p-3 border border-pink-600/20">
//                   <div className="flex items-center gap-2 mb-1">
...
//               <div className="flex justify-end gap-2 mt-6 pt-4 border-t border-pink-600/20">
//                 <button
//                   onClick={() => {
//                     handleViewClose();
...
//                   }}
//                   className="px-3 py-1.5 text-xs font-medium text-pink-600 hover:bg-pink-600/10 rounded-lg transition-colors flex items-center gap-1 border border-pink-600/20"
//                 >
//                   <Edit className="w-3.5 h-3.5" />
//                   Edit Category
//                 </button>
...
//         <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
//           <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden border border-pink-600/20">
...
//                 className="p-1.5 hover:bg-pink-600/10 rounded-lg transition-colors"
//               >
//                 <X className="w-5 h-5 text-gray-500" />
//               </button>
//             </div>
...
//                 <div className="text-center py-12">
//                   <FolderTree className="w-12 h-12 mx-auto text-pink-600/30 mb-3" />
...
//                     }}
//                     className="mt-3 px-4 py-2 bg-pink-600 text-white text-sm rounded-lg hover:bg-blue-700 transition-all shadow-md hover:shadow-lg hover:shadow-pink-600/20 font-semibold"
//                   >
...
//                     return (
//                       <div key={sub._id} className="border border-pink-600/20 rounded-lg overflow-hidden">
//                         <div className="flex items-center justify-between p-3 bg-gradient-to-r from-pink-600/5 to-[#004767]/5 hover:bg-pink-600/10 transition-colors">
//                           <div className="flex items-center gap-3 flex-1">
//                             {childCount > 0 ? (
//                               <button
//                                 onClick={() => toggleViewChildren(sub._id)}
//                                 className="p-0.5 hover:bg-pink-600/20 rounded transition-colors"
//                               >
...
//                                 {childCount > 0 && (
//                                   <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-pink-600/10 text-pink-600 rounded-full text-xs border border-pink-600/20">
...
//                               }}
//                               className="p-1.5 text-gray-600 hover:text-pink-600 hover:bg-pink-600/10 rounded-lg"
//                               title="Edit Subcategory"
//                             >
//                               <Edit className="w-3.5 h-3.5" />
//                             </button>
...
//                         {viewSubcategoriesModal.expandedChildren[sub._id] && (
//                           <div className="pl-8 pr-3 pb-3 pt-2 bg-pink-600/5 border-t border-pink-600/20">
...
//                                   <div key={child._id} className="flex items-center justify-between p-2 bg-white rounded-lg border border-pink-600/20 hover:shadow-sm transition-shadow">
//                                     <div className="flex items-center gap-3 flex-1">
...
//                                         }}
//                                         className="p-1 text-gray-400 hover:text-pink-600 hover:bg-pink-600/10 rounded"
...
//                                 <button
//                                   onClick={() => handleAddChildSubcategory(viewSubcategoriesModal.category, sub)}
//                                   className="w-full mt-2 text-xs text-green-600 hover:text-green-700 flex items-center justify-center gap-1 py-1 border border-dashed border-pink-600/20 rounded-lg hover:bg-green-50"
//                                 >
//                                   <Plus className="w-3 h-3" />
...
//             <div className="px-6 py-4 border-t border-pink-600/20 bg-gradient-to-r from-pink-600/5 to-[#004767]/5 flex justify-end">
//               <button
//                 onClick={() => handleAddSubcategory(viewSubcategoriesModal.category)}
//                 className="px-4 py-2 bg-pink-600 text-white text-sm font-semibold rounded-lg hover:bg-pink-800 transition-all duration-300 flex items-center gap-2 shadow-md hover:shadow-lg hover:shadow-pink-600/20"
//               >
//                 <Plus className="w-4 h-4" />
//                 Add Subcategory
//               </button>
...
//                   </div>
//                 </div>
//                 <button onClick={() => setSubcategoryModal(prev => ({ ...prev, show: false }))} className="p-1 hover:bg-pink-600/10 rounded-lg">
//                   <X className="w-5 h-5 text-gray-500" />
//                 </button>
//               </div>
...
//                           className="w-full px-3 py-2 text-sm border border-pink-600/20 rounded-lg focus:ring-2 focus:ring-pink-600 focus:border-transparent outline-none bg-white hover:border-pink-600/40"
...
//                   className="flex items-center gap-2 px-3 py-2 text-sm text-pink-600 hover:bg-pink-600/10 rounded-lg transition-colors"
//                 >
//                   <Plus className="w-4 h-4" />
//                   Add Another Subcategory
//                 </button>

//                 <div className="flex justify-end gap-3 pt-4 border-t border-pink-600/20">
//                   <button
//                     type="button"
//                     onClick={() => setSubcategoryModal(prev => ({ ...prev, show: false }))}
//                     className="px-4 py-2 text-sm font-medium text-gray-700 hover:bg-pink-600/10 rounded-lg transition-colors"
//                   >
//                     Cancel
//                   </button>
//                   <button
...
//                     className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-pink-600 to-pink-700 text-white text-sm font-medium rounded-lg hover:opacity-90 transition-all duration-300 disabled:opacity-50 shadow-md hover:shadow-lg hover:shadow-pink-600/20"
//                   >
...
//       {editModal.show && (
//         <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
//           <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4 border border-pink-600/20">
//             <div className="p-6">
//               <div className="flex items-center justify-between mb-6">
//                 <div className="flex items-center gap-3">
//                   <div className="p-2 bg-pink-600/10 rounded-lg">
...
//                 </div>
//                 <button onClick={handleEditClose} className="p-1 hover:bg-pink-600/10 rounded-lg transition-colors">
//                   <X className="w-5 h-5 text-gray-500" />
//                 </button>
//               </div>
...
//                           editModal.imageError ? 'border-red-300 bg-red-50' : 'border-pink-600/30 hover:border-pink-600 hover:bg-pink-600/5'
//                         }`}
//                         onClick={() => {
...
//                         />
//                         <Upload className={`w-8 h-8 mx-auto mb-2 ${editModal.imageError ? 'text-red-400' : 'text-pink-600'}`} />
...
//                     <div className="space-y-3">
//                       <div className="flex items-center gap-3">
//                         <div className="relative w-16 h-16 rounded-lg overflow-hidden border border-pink-600/20">
...
//                     type="submit"
//                     disabled={isSubmitting}
//                     className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-pink-600 to-[#004767] text-white text-sm font-medium rounded-lg hover:opacity-90 transition-all duration-300 disabled:opacity-50 shadow-md hover:shadow-lg hover:shadow-pink-600/20"
//                   >
//                     {isSubmitting ? (
//                       <>
//                         <Loader2 className="w-4 h-4 animate-spin" />
...
//                 Are you sure you want to delete <span className="font-semibold text-pink-600">"{deleteModal.name}"</span>?
//               </p>
...
//               <p className="text-gray-600 mb-2">
//                 Are you sure you want to delete <span className="font-semibold text-pink-600">"{deleteSubcategoryModal.subcategoryName}"</span>?
//               </p>
//               <p className="text-sm text-gray-500 mb-6">
...
//   return (
//     <Suspense fallback={
//       <div className="min-h-screen bg-gradient-to-br from-[#004767]/5 via-white to-pink-600/5 flex items-center justify-center">
              ...
              <form onSubmit={handleSubmit} className="p-5 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="w-full px-3 py-2 text-sm border border-pink-600/30 rounded-lg focus:ring-2 focus:ring-pink-600 focus:border-transparent outline-none transition bg-white hover:border-pink-600/50"
                    placeholder="Brief description about this category (Optional)"
                  />
                </div>
              ...
              {viewSubcategoriesModal.isLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <button
                    ...
                    className="mt-3 px-4 py-2 bg-pink-600 text-white text-sm rounded-lg hover:bg-pink-700 transition-all shadow-md hover:shadow-lg hover:shadow-pink-600/20 font-semibold"
                  >
                    Add First Subcategory
                  </button>
                </div>
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
              <div className="flex items-center justify-between mb-6">
                ...
                <button 
                  ...
                  className="p-1 hover:bg-pink-600/10 rounded-lg"
                >
                  <X className="w-5 h-5 text-gray-500" />
                </button>
              </div>
                    ...
                    <div key={child.id} className="flex items-center gap-2">
                      <div className="flex-1 relative">
                        <input
                          ...
                          className="w-full px-3 py-2 text-sm border border-pink-600/20 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none bg-white hover:border-pink-600/40"
              ...
              <form onSubmit={handleEditSubcategorySubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm border border-pink-600/20 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-white hover:border-pink-600/40"
              ...
              <form onSubmit={handleEditChildSubcategorySubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm border border-pink-600/20 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none bg-white hover:border-pink-600/40"
