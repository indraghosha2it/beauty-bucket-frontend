...
// // Helper function to get tag style - HyperVolt Theme
// const getTagStyles = (tag) => {
//   const tagName = getTagName(tag);
//   const styles = {
//     'Best Seller': 'bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-500/30',
//     'Trending': 'bg-gradient-to-r from-[#06B6D4] to-[#0891B2] text-white shadow-lg shadow-[#06B6D4]/30',
...
//   };
//   return styles[tagName] || 'bg-gradient-to-r from-[#06B6D4] to-[#004767] text-white shadow-lg shadow-[#06B6D4]/30';
// };
...
//           <div className="bg-white rounded-2xl h-64 sm:h-96 w-full border border-[#06B6D4]/20"></div>
//         </div>
//         <div className="space-y-3 sm:space-y-4 animate-pulse">
//           <div className="h-6 sm:h-8 bg-[#004767]/10 rounded w-3/4"></div>
//           <div className="h-4 sm:h-6 bg-[#004767]/10 rounded w-1/2"></div>
//           <div className="h-16 sm:h-24 bg-[#004767]/10 rounded"></div>
//           <div className="h-10 sm:h-12 bg-[#004767]/10 rounded w-full"></div>
//         </div>
//       </div>
//     </div>
//   </div>
...
// // Main Admin Product Details Component - HyperVolt Theme
...
//         {/* Header with Back Button and Actions - HyperVolt Theme */}
//         <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
//           <div className="flex items-center gap-2 sm:gap-3">
//             <button
//               onClick={() => router.back()}
//               className="p-2 bg-white rounded-xl border border-[#06B6D4]/20 hover:border-[#06B6D4] transition-all shadow-sm hover:shadow-md"
//             >
//               <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-[#06B6D4]" />
//             </button>
//             <div>
//               <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#004767]">
//                 Product Details
//               </h1>
//               <p className="text-xs sm:text-sm text-[#64748B] mt-0.5">View complete product information</p>
//             </div>
//           </div>
//           <div className="flex items-center gap-2 sm:gap-3">
//             <button
//               onClick={handleEdit}
//               className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-[#06B6D4] to-[#004767] text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-[#06B6D4]/25 transition-all text-xs sm:text-sm"
//             >
...
//               className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-red-500 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-red-500/25 transition-all text-xs sm:text-sm"
//             >
...
//           <Link href="/authorize/dashboard" className="text-[#64748B] hover:text-[#06B6D4] transition whitespace-nowrap">Dashboard</Link>
//           <span className="text-[#06B6D4]/30">/</span>
//           <Link href="/authorize/all-products" className="text-[#64748B] hover:text-[#06B6D4] transition whitespace-nowrap">Products</Link>
//           <span className="text-[#06B6D4]/30">/</span>
//           <span className="text-[#004767] font-medium truncate max-w-[100px] sm:max-w-[150px]">
//             {product.productName}
//           </span>
//         </nav>

//         {/* Product Title and Status Bar - HyperVolt Styled */}
//         <div className="bg-white rounded-xl sm:rounded-2xl border border-[#06B6D4]/20 p-3 sm:p-4 md:p-5 mb-4 sm:mb-6 shadow-lg shadow-[#06B6D4]/5">
//           <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-3">
//             <div>
//               <h2 className="text-base sm:text-lg md:text-xl font-bold text-[#004767]">
//                 {product.productName}
//               </h2>
//               <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-0.5 sm:mt-1">
//                 <p className="text-[10px] sm:text-xs text-[#64748B]">SKU: {product.skuCode}</p>
//                 {product.brand && (
//                   <span className="inline-flex items-center gap-0.5 sm:gap-1 text-[10px] sm:text-xs text-[#64748B]">
...
//               <div className="relative bg-white rounded-xl sm:rounded-2xl border border-[#06B6D4]/20 overflow-hidden shadow-lg shadow-[#06B6D4]/5">
//                 <div 
//                   className="relative bg-[#F0F7FA] rounded-xl sm:rounded-2xl overflow-hidden cursor-crosshair"
...
//                       <div className="absolute inset-0 bg-gradient-to-br from-[#06B6D4]/5 to-[#004767]/5 animate-pulse z-10" />
//                     )}
...
//                       <div className="bg-white/80 backdrop-blur-sm text-[#004767] text-[8px] sm:text-[10px] px-2 py-1 sm:px-3 sm:py-1.5 rounded-full flex items-center gap-1 sm:gap-2 opacity-0 hover:opacity-100 transition-opacity shadow-lg border border-[#06B6D4]/20">
//                         <ZoomIn className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 text-[#06B6D4]" />
...
//                       >
//                         <Maximize2 className="w-3 h-3 sm:w-4 sm:h-4 text-[#06B6D4]" />
//                       </button>
//                     )}
//                   </div>
...
//                 {discountPercent > 0 && (
//                   <div className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-gradient-to-r from-[#06B6D4] to-[#004767] text-white text-[8px] sm:text-[10px] md:text-sm font-bold px-1.5 py-0.5 sm:px-2.5 sm:py-1.5 rounded-full shadow-lg flex items-center gap-0.5 sm:gap-1">
...
//                       activeImageIndex === idx ? 'border-[#06B6D4] shadow-[0_0_0_3px_rgba(6,182,212,0.2)]' : 'border-[#06B6D4]/20 hover:border-[#06B6D4]/50'
//                     }`}
//                   >
...
//                       activeImageIndex === productImages.length ? 'border-[#06B6D4] shadow-[0_0_0_3px_rgba(6,182,212,0.2)]' : 'border-[#06B6D4]/20 hover:border-[#06B6D4]/50'
//                     }`}
//                   >
...
//                     <div 
//                       className="fallback-icon w-full h-full bg-gradient-to-br from-[#06B6D4]/10 to-[#004767]/5 flex flex-col items-center justify-center"
//                       style={{ 
...
//                       {generatingThumbnail ? (
//                         <>
//                           <Loader2 className="w-3 h-3 sm:w-4 sm:h-4 text-[#06B6D4] animate-spin" />
//                           <span className="text-[5px] sm:text-[6px] md:text-[8px] text-[#06B6D4] mt-0.5">Loading</span>
//                         </>
//                       ) : (
//                         <>
//                           <Play className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-[#06B6D4]" />
//                           <span className="text-[5px] sm:text-[6px] md:text-[8px] text-[#06B6D4] mt-0.5">Video</span>
//                         </>
//                       )}
//                     </div>
...
//           {/* Right Column - Product Info - HyperVolt Styled */}
//           <div className="lg:col-span-4 bg-white p-3 sm:p-4 md:p-5 lg:p-6 rounded-xl sm:rounded-2xl border border-[#06B6D4]/20 shadow-lg shadow-[#06B6D4]/5">
//             {/* Category Hierarchy */}
//             <div className="flex flex-wrap items-center gap-1 sm:gap-1.5 mb-3 sm:mb-4">
//               {categoryHierarchy.map((cat, idx) => (
//                 <span 
//                   key={idx} 
//                   className="inline-flex items-center gap-0.5 px-1.5 py-0.5 sm:px-2.5 sm:py-1 text-[8px] sm:text-[10px] md:text-xs font-medium rounded-full bg-[#06B6D4]/10 text-[#06B6D4] border border-[#06B6D4]/20"
//                 >
...
//               {product.brand && (
//                 <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 sm:px-2.5 sm:py-1 text-[8px] sm:text-[10px] md:text-xs font-medium rounded-full bg-[#06B6D4]/10 text-[#06B6D4] border border-[#06B6D4]/20">
...
//               <h1 className="text-base sm:text-xl md:text-2xl font-bold text-[#004767]">
//                 {product.productName}
//               </h1>
//             </div>

//             {/* Price Card - HyperVolt Styled */}
//             <div className="mb-4 sm:mb-5 p-3 sm:p-4 bg-gradient-to-r from-[#06B6D4]/5 to-[#004767]/5 rounded-xl border border-[#06B6D4]/20">
//               <div className="flex items-baseline gap-2 sm:gap-3 flex-wrap">
//                 <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#06B6D4]">
//                   ৳{formatPrice(currentPrice)}
//                 </span>
//                 {discountPercent > 0 && (
//                   <>
//                     <span className="text-sm sm:text-base text-gray-400 line-through">৳{formatPrice(product.regularPrice)}</span>
//                     <span className="inline-flex items-center gap-1 text-[10px] sm:text-xs font-semibold text-white bg-gradient-to-r from-[#06B6D4] to-[#004767] px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full">
...
//             {/* Short Description */}
//             <div className="mb-4 sm:mb-5 p-2 sm:p-3 bg-[#F0F7FA] rounded-xl border border-[#06B6D4]/10">
//               {product.shortDescription && product.shortDescription !== '<p></p>' ? (
//                 <div 
//                   className="text-[11px] sm:text-sm text-[#64748B] leading-relaxed"
...
//               <div className="mb-4 p-2 bg-[#F0F7FA] rounded-lg border border-[#06B6D4]/10">
//                 <p className="text-[10px] sm:text-xs text-[#64748B] flex items-center gap-1.5">
//                   <AlertCircle className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#06B6D4]" />
...
//     <div className="bg-[#F0F7FA] rounded-lg p-2 sm:p-3 border border-[#06B6D4]/10">
//       <p className="text-[8px] sm:text-[10px] text-[#64748B] flex items-center gap-1">
//         <Box className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#06B6D4]" />
//         Packaging Cost
//       </p>
//       <p className="text-sm sm:text-base font-bold text-[#004767]">
...
//     <div className="bg-[#F0F7FA] rounded-lg p-2 sm:p-3 border border-[#06B6D4]/10">
//       <p className="text-[8px] sm:text-[10px] text-[#64748B] flex items-center gap-1">
//         <Truck className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#06B6D4]" />
//         Delivery Cost
//       </p>
//       <p className="text-sm sm:text-base font-bold text-[#004767]">
...
//     <div className="bg-[#F0F7FA] rounded-lg p-2 sm:p-3 border border-[#06B6D4]/10">
//       <p className="text-[8px] sm:text-[10px] text-[#64748B] flex items-center gap-1">
//         <DollarSign className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#06B6D4]" />
//         Cost Per Item
//       </p>
//       <p className="text-sm sm:text-base font-bold text-[#004767]">
...
//               <div className="bg-[#F0F7FA] rounded-lg p-2 border border-[#06B6D4]/10">
//                 <p className="text-[8px] sm:text-[10px] text-[#64748B]">Unit</p>
//                 <p className="text-xs sm:text-sm font-medium text-[#004767]">{product.unit === 'pcs' ? 'Pieces' : product.unit || 'N/A'}</p>
//               </div>
//               <div className="bg-[#F0F7FA] rounded-lg p-2 border border-[#06B6D4]/10">
//                 <p className="text-[8px] sm:text-[10px] text-[#64748B]">SKU</p>
//                 <p className="text-xs sm:text-sm font-medium text-[#004767] font-mono">{product.skuCode}</p>
//               </div>
//             </div>
...
//             {/* ============================================ */}
//             {isAdminOrSuperAdmin && hasBuyingPrice && (
//               <div className="mb-4 p-2 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg border border-amber-200">
//                 <p className="text-[10px] sm:text-xs text-amber-700 flex items-center gap-1.5">
//                   <DollarSign className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-amber-600" />
//                   Buying Price: <span className="font-medium text-amber-800">৳{formatPrice(product.buyingPrice)}</span>
//                   <span className="ml-2 text-[8px] sm:text-[10px] text-amber-500 bg-amber-100 px-1.5 py-0.5 rounded-full">
//                     Admin Only
//                   </span>
//                 </p>
//               </div>
...
//               <div className="bg-gradient-to-r from-[#06B6D4]/5 to-[#004767]/5 rounded-xl p-3 sm:p-4 border border-[#06B6D4]/20 mb-4">
//                 <div className="flex items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3">
//                   <Truck className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-[#06B6D4]" />
//                   <span className="font-semibold text-[#004767] text-sm sm:text-base">
//                     Delivery Information
//                   </span>
//                 </div>
//                 <div 
//                   className="prose prose-sm max-w-none text-[#64748B] text-[10px] sm:text-sm"
//                   style={{ fontSize: '0.875rem', lineHeight: '1.6' }}
//                   dangerouslySetInnerHTML={{ __html: product.deliveryInfo }} 
//                 />
//                 <div className="flex flex-wrap items-center gap-2 sm:gap-4 mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-[#06B6D4]/10">
//                   <div className="flex items-center gap-0.5 sm:gap-1 text-[8px] sm:text-[10px] text-[#64748B]">
...
//             {/* ============================================ */}
//             {isAdminOrSuperAdmin && (
//               <div className="mt-4 p-3 sm:p-4 bg-gradient-to-r from-gray-50 to-[#F0F7FA] rounded-xl border border-gray-200">
//                 <h4 className="text-xs font-semibold text-[#004767] mb-2 flex items-center gap-1.5">
//                   <ClockIcon className="w-3.5 h-3.5 text-[#06B6D4]" />
//                   Product Tracking Information
//                 </h4>
//                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
//                   <div className="flex items-start gap-1.5">
//                     <User className="w-3 h-3 text-[#64748B] flex-shrink-0 mt-0.5" />
//                     <div>
//                       <p className="text-[10px] text-[#64748B]">Created By</p>
//                       <p className="font-medium text-[#004767] text-[11px]">
//                         {product.createdBy?.name || product.createdBy?.email || 'Unknown'}
//                       </p>
//                     </div>
//                   </div>
//                   <div className="flex items-start gap-1.5">
//                     <Calendar className="w-3 h-3 text-[#64748B] flex-shrink-0 mt-0.5" />
//                     <div>
//                       <p className="text-[10px] text-[#64748B]">Created At</p>
//                       <p className="font-medium text-[#004767] text-[11px]">
...
//                     <User className="w-3 h-3 text-[#64748B] flex-shrink-0 mt-0.5" />
//                     <div>
//                       <p className="text-[10px] text-[#64748B]">Last Updated By</p>
//                       <p className="font-medium text-[#004767] text-[11px]">
...
//                   </div>
//                   <div className="flex items-start gap-1.5">
//                     <ClockIcon className="w-3 h-3 text-[#64748B] flex-shrink-0 mt-0.5" />
//                     <div>
//                       <p className="text-[10px] text-[#64748B]">Last Updated At</p>
//                       <p className="font-medium text-[#004767] text-[11px]">
...
//                   <div className="flex items-start gap-1.5">
//                     <Building2 className="w-3 h-3 text-[#64748B] flex-shrink-0 mt-0.5" />
//                     <div>
//                       <p className="text-[10px] text-[#64748B]">Product ID</p>
//                       <p className="font-mono text-[10px] text-[#64748B]">{product._id}</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//         {/* Tabs Section - HyperVolt Styled with FAQ Tab */}
//         <div className="mt-6 sm:mt-10 md:mt-14">
//           <div className="flex flex-wrap gap-0.5 sm:gap-1 border-b border-[#06B6D4]/20">
...
//                     activeTab === tab 
//                       ? 'bg-white text-[#06B6D4] border-t-2 border-l-2 border-r-2 border-[#06B6D4]/30 border-b-white shadow-sm' 
//                       : 'text-[#64748B] hover:text-[#004767]'
//                   }`}
//                 >
//                   {icons[tab]}
//                   {labels[tab]}
//                   {tab === 'faqs' && product.faqs && product.faqs.length > 0 && (
//                     <span className="bg-[#06B6D4]/10 text-[#06B6D4] text-[10px] px-1.5 py-0.5 rounded-full ml-1">
//                       {product.faqs.length}
//                     </span>
//                   )}
//                 </button>
...
//           <div className="bg-white rounded-b-lg sm:rounded-b-xl rounded-tr-lg sm:rounded-tr-xl border border-t-0 border-[#06B6D4]/20 p-3 sm:p-4 md:p-6">
//             {activeTab === 'details' && (
//               <div className="prose prose-sm max-w-none text-[#64748B] text-[12px] sm:text-sm">
...
//                   <div key={idx} className={`flex items-center gap-2 sm:gap-3 p-2 sm:p-3 ${item.isAdminOnly ? 'bg-amber-50 border-amber-200' : 'bg-[#F0F7FA] border-[#06B6D4]/10'} rounded-lg sm:rounded-xl border`}>
//                     <div className={`p-1.5 sm:p-2 ${item.isAdminOnly ? 'bg-amber-100' : 'bg-[#06B6D4]/10'} rounded-full`}>
//                       <item.icon className={`w-3 h-3 sm:w-4 sm:h-4 ${item.isAdminOnly ? 'text-amber-600' : 'text-[#06B6D4]'}`} />
//                     </div>
//                     <div>
//                       <p className="text-[8px] sm:text-[10px] text-[#64748B]">{item.label}</p>
//                       <p className={`font-medium ${item.isAdminOnly ? 'text-amber-700' : 'text-[#004767]'} text-[10px] sm:text-xs md:text-sm`}>
//                         {item.value || 'N/A'}
//                       </p>
//                       {item.isAdminOnly && (
...
//                       <div key={`additional-${idx}`} className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-[#F0F7FA] rounded-lg sm:rounded-xl border border-[#06B6D4]/10">
//                         <div className="p-1.5 sm:p-2 bg-[#06B6D4]/10 rounded-full">
//                           <Info className="w-3 h-3 sm:w-4 sm:h-4 text-[#06B6D4]" />
//                         </div>
//                         <div>
//                           <p className="text-[8px] sm:text-[10px] text-[#64748B]">{info.fieldName}</p>
//                           <p className="font-medium text-[#004767] text-[10px] sm:text-xs md:text-sm">{info.fieldValue}</p>
//                         </div>
//                       </div>
//                     ))}
//                   </div>
...
//                     <Info className="w-8 h-8 sm:w-12 sm:h-12 text-[#06B6D4]/30 mx-auto mb-2 sm:mb-3" />
//                     <p className="text-[#64748B] text-sm">No additional information available</p>
//                   </div>
//                 )}
//               </>
//             )}
...
//                   <div className="p-2 sm:p-3 bg-[#F0F7FA] rounded-lg sm:rounded-xl border border-[#06B6D4]/10">
//                     <p className="text-[8px] sm:text-[10px] text-[#64748B] mb-0.5 sm:mb-1">Meta Title</p>
//                     <p className="font-medium text-[#004767] text-xs sm:text-sm">{product.metaSettings.metaTitle}</p>
//                   </div>
//                 )}
//                 {product.metaSettings?.metaDescription && (
//                   <div className="p-2 sm:p-3 bg-[#F0F7FA] rounded-lg sm:rounded-xl border border-[#06B6D4]/10">
//                     <p className="text-[8px] sm:text-[10px] text-[#64748B] mb-0.5 sm:mb-1">Meta Description</p>
//                     <p className="font-medium text-[#004767] text-xs sm:text-sm">{product.metaSettings.metaDescription}</p>
//                   </div>
//                 )}
//                 {product.metaSettings?.metaKeywords && product.metaSettings.metaKeywords.length > 0 && (
//                   <div className="p-2 sm:p-3 bg-[#F0F7FA] rounded-lg sm:rounded-xl border border-[#06B6D4]/10">
//                     <p className="text-[8px] sm:text-[10px] text-[#64748B] mb-1 sm:mb-2">Meta Keywords</p>
//                     <div className="flex flex-wrap gap-1 sm:gap-2">
//                       {product.metaSettings.metaKeywords.map((keyword, idx) => (
//                         <span key={idx} className="px-1.5 py-0.5 sm:px-2 sm:py-1 bg-white rounded-md text-[8px] sm:text-xs text-[#004767] border border-[#06B6D4]/20">
//                           {keyword}
//                         </span>
//                       ))}
//                     </div>
...
//                   <div className="text-center py-6 sm:py-8">
//                     <Package className="w-8 h-8 sm:w-12 sm:h-12 text-[#06B6D4]/30 mx-auto mb-2 sm:mb-3" />
//                     <p className="text-[#64748B] text-sm">No SEO & Meta settings available</p>
//                   </div>
//                 )}
//               </div>
//             )}
...
//                   <div>
//                     {/* FAQ Header */}
//                     <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#06B6D4]/20">
//                       <div className="flex items-center gap-3">
//                         <div className="p-2 bg-gradient-to-br from-[#06B6D4] to-[#004767] rounded-xl shadow-lg shadow-[#06B6D4]/20">
//                           <HelpCircle className="w-5 h-5 text-white" />
//                         </div>
//                         <div>
//                           <h3 className="text-lg font-bold text-[#004767]">Frequently Asked Questions</h3>
//                           <p className="text-sm text-[#64748B]">Customer questions and answers about this product</p>
//                         </div>
//                       </div>
//                       <div className="hidden sm:flex items-center gap-1 text-sm text-[#64748B] bg-[#F0F7FA] px-3 py-1.5 rounded-full">
...
//                               isOpen 
//                                 ? 'border-[#06B6D4] shadow-md shadow-[#06B6D4]/10 bg-white' 
//                                 : 'border-[#06B6D4]/20 hover:border-[#06B6D4]/40 bg-white'
//                             }`}
//                           >
//                             {/* Question - Click to toggle */}
//                             <button
//                               onClick={() => toggleFaq(index)}
//                               className="w-full flex items-center gap-4 px-5 py-4 text-left hover:bg-[#F0F7FA]/80 transition-colors"
//                             >
//                               {/* Number */}
//                               <span className="flex-shrink-0 w-7 h-7 rounded-full bg-[#06B6D4]/10 text-[#06B6D4] flex items-center justify-center text-sm font-bold">
//                                 {index + 1}
//                               </span>
                              
//                               {/* Question Text */}
//                               <span className="flex-1 font-semibold text-[#004767] text-base sm:text-lg">
//                                 {faq.question}
//                               </span>
...
//                               }`}
//                             >
//                               <div className="px-5 pb-4 pt-1 border-t border-[#06B6D4]/10">
//                                 <div className="flex items-start gap-3 pl-11">
//                                   <div className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-[#06B6D4] mt-2"></div>
...
//                     <div className="w-16 h-16 bg-[#F0F7FA] rounded-full flex items-center justify-center mx-auto mb-4">
//                       <HelpCircle className="w-8 h-8 text-[#06B6D4]/40" />
//                     </div>
//                     <h3 className="text-lg font-semibold text-[#004767] mb-2">No FAQs Available</h3>
//                     <p className="text-[#64748B] text-sm">This product doesn't have any frequently asked questions yet.</p>
//                   </div>
//                 )}
//               </div>
//             )}
...
//         {/* Tags Section - HyperVolt Styled */}
//         {product.tags && product.tags.length > 0 && (
//           <div className="mt-4 sm:mt-6">
//             <div className="bg-white rounded-xl sm:rounded-2xl border border-[#06B6D4]/20 p-3 sm:p-4 shadow-lg shadow-[#06B6D4]/5">
//               <h3 className="font-semibold text-[#004767] mb-2 sm:mb-3 flex items-center gap-1.5 sm:gap-2 text-sm sm:text-base">
//                 <Tag className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#06B6D4]" />
//                 Product Tags
//               </h3>
...
//             <div className="bg-white rounded-xl sm:rounded-2xl border border-[#06B6D4]/20 p-3 sm:p-4 shadow-lg shadow-[#06B6D4]/5">
//               <h3 className="font-semibold text-[#004767] mb-2 sm:mb-3 flex items-center gap-1.5 sm:gap-2 text-sm sm:text-base">
//                 <Palette className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#06B6D4]" />
//                 Available Colors
//               </h3>
...
//                     <div 
//                       className="w-6 h-6 sm:w-8 sm:h-8 rounded-full border-2 border-[#06B6D4]/30 shadow-sm"
...
// Helper function to get tag style - Black & Blue Theme
const getTagStyles = (tag) => {
  const tagName = getTagName(tag);
  const styles = {
    'Best Seller': 'bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-500/30',
    'Trending': 'bg-gradient-to-r from-blue-600 to-blue-800 text-white shadow-lg shadow-blue-600/30',
    'New Release': 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg shadow-emerald-500/30',
    'Limited Offer': 'bg-gradient-to-r from-purple-500 to-pink-600 text-white shadow-lg shadow-purple-500/30',
    'Flash Sale': 'bg-gradient-to-r from-red-500 to-orange-600 text-white shadow-lg shadow-red-500/30',
    'Clearance': 'bg-gradient-to-r from-gray-500 to-gray-700 text-white shadow-lg shadow-gray-500/30',
  };
  return styles[tagName] || 'bg-gradient-to-r from-blue-600 to-black text-white shadow-lg shadow-blue-600/30';
};
...
// Main Admin Product Details Component - Black & Blue Theme
export default function AdminProductDetails() {
  const router = useRouter();
  const searchParams = useSearchParams();
  const productId = searchParams.get('id');
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 md:py-6 lg:py-8 max-w-7xl">
        ...
        {/* Header with Back Button and Actions - Black & Blue Theme */}
        <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="flex items-center gap-2 sm:gap-3">
          <button
  onClick={() => window.location.href = '/authorize/all-products'}
  className="p-2 bg-white rounded-xl border border-gray-200 hover:border-blue-600 transition-all shadow-sm hover:shadow-md"
>
  <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 hover:text-blue-600" />
</button>
            <div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              onClick={handleEdit}
              className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all text-xs sm:text-sm shadow-md hover:shadow-lg"
            >
              <Edit className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              Edit Product
            </button>
        ...
        {/* Breadcrumb - Black & Blue Style */}
        <nav className="flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-xs md:text-sm mb-4 sm:mb-6 overflow-x-auto pb-1 sm:pb-2 scrollbar-hide">
          <Link href="/authorize/dashboard" className="text-gray-500 hover:text-blue-600 transition whitespace-nowrap">Dashboard</Link>
          <span className="text-gray-300">/</span>
          <Link href="/authorize/all-products" className="text-gray-500 hover:text-blue-600 transition whitespace-nowrap">Products</Link>
          <span className="text-gray-300">/</span>
        ...
        {/* Product Title and Status Bar - Black & Blue Styled */}
            ...
            <div className="sticky top-20 lg:top-24">
              ...
              <div className="relative bg-white rounded-xl sm:rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                ...
                >
                  <div className="relative w-full pt-[100%] sm:pt-[100%]">
                    {(isTransitioning || !imageLoaded[activeImageIndex]) && !isMainVideo && (
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-gray-50 animate-pulse z-10" />
                    )}
  ...
  {!isMainVideo && mainImage ? (
    ...
    mainVideoType === 'youtube' ? (
      ...
      />
                  ...
                  {!isMainVideo && !isMobile && !isZoomed && (
                    <div className="absolute inset-0 bg-black/0 hover:bg-black/5 transition-all duration-300 flex items-center justify-center pointer-events-none">
                      <div className="bg-white/80 backdrop-blur-sm text-gray-700 text-[8px] sm:text-[10px] px-2 py-1 sm:px-3 sm:py-1.5 rounded-full flex items-center gap-1 sm:gap-2 opacity-0 hover:opacity-100 transition-opacity shadow-lg border border-gray-200">
                        <ZoomIn className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 text-blue-600" />
                        <span className="hidden xs:inline font-medium">Hover to zoom</span>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="absolute bottom-2 right-2 sm:bottom-3 sm:right-3 flex gap-1 sm:gap-2 z-20">
                    {!isMainVideo && (
                      <button
                        ...
                        aria-label="View fullscreen"
                      >
                        <Maximize2 className="w-3 h-3 sm:w-4 sm:h-4 text-blue-600" />
                      </button>
                    )}
                  </div>
                ...
                {discountPercent > 0 && (
                  <div className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-blue-600 text-white text-[8px] sm:text-[10px] md:text-sm font-bold px-1.5 py-0.5 sm:px-2.5 sm:py-1.5 rounded-full shadow-lg flex items-center gap-0.5 sm:gap-1">
                    <Tag className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5" />
                    {discountPercent}% OFF
                  </div>
                )}
              ...
              <div className="flex gap-1.5 sm:gap-2 mt-2 sm:mt-3 overflow-x-auto pb-2 scrollbar-thin justify-start sm:justify-center">
                {productImages.map((img, idx) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 md:w-[60px] md:h-[60px] rounded-lg overflow-hidden border-2 transition-all duration-200 ${
                      activeImageIndex === idx ? 'border-blue-600 shadow-[0_0_0_3px_rgba(59,130,246,0.2)]' : 'border-gray-200 hover:border-blue-400'
                    }`}
                  >
                    <img src={img.url} alt={`Thumb ${idx + 1}`} className="w-full h-full object-cover" />
                  </button>
                ...
                {hasVideo && (
                  <button
                    ...
                    className={`flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 md:w-[60px] md:h-[60px] rounded-lg overflow-hidden border-2 transition-all duration-200 relative ${
                      activeImageIndex === productImages.length ? 'border-blue-600 shadow-[0_0_0_3px_rgba(59,130,246,0.2)]' : 'border-gray-200 hover:border-blue-400'
                    }`}
                  >
                    {product.videoType === 'youtube' && getYouTubeThumbnail(product.videoUrl) ? (
                      <img 
                    ...
                    <div 
                      className="fallback-icon w-full h-full bg-gradient-to-br from-blue-50 to-gray-50 flex flex-col items-center justify-center"
                      style={{ 
                        display: (product.videoType === 'youtube' && getYouTubeThumbnail(product.videoUrl)) || 
                                 (product.videoType !== 'youtube' && videoThumbnail) ? 'none' : 'flex' 
                      }}
                    >
                      {generatingThumbnail ? (
                        <>
                          ...
                          <span className="text-[5px] sm:text-[6px] md:text-[8px] text-blue-600 mt-0.5">Loading</span>
                        </>
                      ) : (
                        <>
                          <Play className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-blue-600" />
                          <span className="text-[5px] sm:text-[6px] md:text-[8px] text-blue-600 mt-0.5">Video</span>
                        </>
                      )}
                    </div>
          ...
          {/* Right Column - Product Info - Black & Blue Styled */}
          <div className="lg:col-span-4 bg-white p-3 sm:p-4 md:p-5 lg:p-6 rounded-xl sm:rounded-2xl border border-gray-200 shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-1 sm:gap-1.5 mb-3 sm:mb-4">
              {categoryHierarchy.map((cat, idx) => (
                <span 
                  key={idx} 
                  className="inline-flex items-center gap-0.5 px-1.5 py-0.5 sm:px-2.5 sm:py-1 text-[8px] sm:text-[10px] md:text-xs font-medium rounded-full bg-blue-50 text-blue-700 border border-blue-200"
                >
                  <FolderTree className="w-2 h-2 sm:w-2.5 sm:h-2.5" />
                  {cat}
                </span>
              ...
              {product.brand && (
                <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 sm:px-2.5 sm:py-1 text-[8px] sm:text-[10px] md:text-xs font-medium rounded-full bg-blue-50 text-blue-700 border border-blue-200">
                  <Building2 className="w-2 h-2 sm:w-2.5 sm:h-2.5" />
                  {product.brand}
                </span>
              )}
            ...
            {/* Price Card - Black & Blue Styled */}
            <div className="mb-4 sm:mb-5 p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-gray-50 rounded-xl border border-blue-200">
              <div className="flex items-baseline gap-2 sm:gap-3 flex-wrap">
                ...
                {discountPercent > 0 && (
                  <>
                    <span className="text-sm sm:text-base text-gray-400 line-through">৳{formatPrice(product.regularPrice)}</span>
                    <span className="inline-flex items-center gap-1 text-[10px] sm:text-xs font-semibold text-white bg-blue-600 px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full">
                      <Zap className="w-2 h-2 sm:w-3 sm:h-3" />
                      Save {discountPercent}%
                    </span>
                  </>
            ...
            {product.stockAlertQuantity > 0 && (
              <div className="mb-4 p-2 bg-gray-50 rounded-lg border border-gray-200">
                <p className="text-[10px] sm:text-xs text-gray-600 flex items-center gap-1.5">
                  <AlertCircle className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-blue-600" />
                  Stock Alert: Notify when stock reaches {product.stockAlertQuantity}
                </p>
              </div>
            )}
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-4">
              ...
              {product.packagingCost !== undefined && product.packagingCost !== null && (
                <div className="bg-gray-50 rounded-lg p-2 sm:p-3 border border-gray-200">
                  <p className="text-[8px] sm:text-[10px] text-gray-500 flex items-center gap-1">
                    <Box className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-blue-600" />
                    Packaging Cost
                  </p>
              ...
              {!isModerator && product.costPerItem !== undefined && product.costPerItem !== null && product.costPerItem > 0 && (
                <div className="bg-gray-50 rounded-lg p-2 sm:p-3 border border-gray-200">
                  <p className="text-[8px] sm:text-[10px] text-gray-500 flex items-center gap-1">
                    <DollarSign className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-blue-600" />
                    Cost Per Item
                  </p>
                  <p className="text-sm sm:text-base font-bold text-gray-900">
                    ৳{formatPrice(product.costPerItem)}
            ...
            {/* Delivery Info */}
            {product.deliveryInfo && product.deliveryInfo !== '<p></p>' && product.deliveryInfo.trim() !== '' && (
              <div className="bg-gradient-to-r from-blue-50 to-gray-50 rounded-xl p-3 sm:p-4 border border-blue-200 mb-4">
                <div className="flex items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3">
                  <Truck className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-blue-600" />
                ...
                <div 
                  ...
                  dangerouslySetInnerHTML={{ __html: product.deliveryInfo }} 
                />
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-blue-200/50">
        ...
        {/* Tabs Section - Black & Blue Styled with FAQ Tab */}
        <div className="mt-6 sm:mt-10 md:mt-14">
            ...
            {['details', 'specifications', 'additional', 'meta', 'faqs'].map(tab => {
              ...
              return (
                <button
                  ...
                  className={`px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 md:py-2.5 font-semibold text-[10px] sm:text-xs md:text-sm rounded-t-lg sm:rounded-t-xl transition-all flex items-center gap-1.5 ${
                    activeTab === tab 
                      ? 'bg-white text-blue-600 border-t-2 border-l-2 border-r-2 border-blue-200 border-b-white shadow-sm' 
          ...
          <div className="bg-white rounded-b-lg sm:rounded-b-xl rounded-tr-lg sm:rounded-tr-xl border border-t-0 border-gray-200 p-3 sm:p-4 md:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                {[
                  ...
                  <div key={idx} className={`flex items-center gap-2 sm:gap-3 p-2 sm:p-3 ${item.isAdminOnly ? 'bg-amber-50 border-amber-200' : 'bg-gray-50 border-gray-200'} rounded-lg sm:rounded-xl border`}>
                    <div className={`p-1.5 sm:p-2 ${item.isAdminOnly ? 'bg-amber-100' : 'bg-blue-100'} rounded-full`}>
                      <item.icon className={`w-3 h-3 sm:w-4 sm:h-4 ${item.isAdminOnly ? 'text-amber-600' : 'text-blue-600'}`} />
                    </div>
                    <div>
            ...
            {activeTab === 'additional' && (
              <>
                {product.additionalInfo && product.additionalInfo.length > 0 ? (
                  ...
                  <div className="text-center py-6 sm:py-8">
                    <Info className="w-8 h-8 sm:w-12 sm:h-12 text-blue-300 mx-auto mb-2 sm:mb-3" />
            ...
            {activeTab === 'meta' && (
              <div className="space-y-3 sm:space-y-4">
                ...
                {!product.metaSettings?.metaTitle && !product.metaSettings?.metaDescription && (!product.metaSettings?.metaKeywords || product.metaSettings.metaKeywords.length === 0) && (
                  <div className="text-center py-6 sm:py-8">
                    <Package className="w-8 h-8 sm:w-12 sm:h-12 text-blue-300 mx-auto mb-2 sm:mb-3" />
                      ...
                      {product.faqs.map((faq, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              <div className="px-5 pb-4 pt-1 border-t border-blue-100/50">
                                <div className="flex items-start gap-3 pl-11">
        ...
        {/* Tags Section - Black & Blue Styled */}
        {product.tags && product.tags.length > 0 && (
          <div className="mt-4 sm:mt-6">
