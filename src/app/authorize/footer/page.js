...
// // Default footer structure - Smart Gadget branding
...
//           <div className="w-24 h-24 rounded-lg overflow-hidden border-2 border-blue-400/30 bg-gray-100">
//             <img 
//               src={preview} 
//               alt="Logo" 
...
//               >
//                 <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600 hover:text-gray-900" />
//               </button>
...
//                       Manage the columns displayed in the footer. Use "Support + Social" type for support links with "Connect With Us" section.
//                     </p>
//                   </div>
//                   <button
//                     type="button"
