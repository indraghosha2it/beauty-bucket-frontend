...
const ProductCard = ({ 
  ...
  return (
    ...
    } overflow-hidden ${isSelected ? 'ring-2 ring-pink-600 ring-offset-2' : ''}`}>
      <div className="p-4">
        <div className="flex gap-4">
          ...
          {showCheckbox && canDelete && (
            <div className="flex items-center justify-center flex-shrink-0">
              <button
                ...
                className="w-5 h-5 rounded border-2 border-gray-300 flex items-center justify-center hover:border-pink-600 transition-colors"
              >
                {isSelected ? (
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-1.5">
              <h3 className="text-sm font-semibold text-gray-900 truncate hover:text-pink-600 transition-colors max-w-[700px]" title={product.productName}>
                {product.productName}
              </h3>
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {/* <Link href="/authorize/dashboard" className="p-2 hover:bg-pink-600/20 rounded-lg transition-colors">
                <ArrowLeft className="w-5 h-5 text-black/80 hover:text-black" />
              </Link> */}

              <a href="/authorize/dashboard" className="p-2 hover:bg-pink-600/20 rounded-lg transition-colors">
  <ArrowLeft className="w-5 h-5 text-black/80 hover:text-black" />
</a>
              <div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="p-2 text-white/70 hover:bg-pink-600/20 rounded-lg transition-colors hover:text-white"
                title="Refresh"
              >
              ...
              {/* <Link
                ...
                className="flex items-center gap-2 px-4 py-2 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition-colors text-sm font-semibold shadow-md"
              >
...
>
  ...
  <span>Add Product</span>
          ...
          {showCheckboxes && canDelete && (
            <div className="flex items-center gap-4 mt-3 pt-3 border-t border-pink-600/20">
              <button
          ...
          <>
            {products.length === 0 ? (
              <div className="text-center py-20 bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <button
                  onClick={clearFilters}
                  className="px-4 py-2 bg-pink-600 text-white text-sm font-semibold rounded-lg hover:bg-pink-700 transition-colors shadow-md"
                >
                  Clear Filters
                </button>
              </div>
