...
export default function EmailSettingsPage() {
  ...
  const renderEmailSettings = (type, settings, status, onSave, onTest, isTesting) => {
    const isOrder = type === 'order';
    const title = isOrder ? 'Order Email Configuration' : 'System Email Configuration';
    const icon = isOrder ? <FaShoppingBag className="text-[#EE4275]" /> : <FaCog className="text-[#EE4275]" />;
    const description = isOrder 
      ? 'Configure email settings for order confirmations, status updates, and invoices'
      : 'Configure email settings for password reset, admin notifications, and system alerts';

    return (
      <div className="bg-white rounded-2xl border border-[#EE4275]/20 p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            {icon}
            <div>
              <h3 className="text-lg font-bold text-[#2D1B2E]">{title}</h3>
              <p className="text-xs text-[#EE4275]/60">{description}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[#2D1B2E] mb-1">
              SMTP Host <span className="text-[#EE4275]">*</span>
            </label>
            <input
              type="text"
              name="smtpHost"
          ...
          <div>
            <label className="block text-sm font-medium text-[#2D1B2E] mb-1">
              SMTP Port <span className="text-[#EE4275]">*</span>
            </label>
            <input
              type="text"
              name="smtpPort"
          ...
          <div>
            <label className="block text-sm font-medium text-[#2D1B2E] mb-1">
              SMTP Username <span className="text-[#EE4275]">*</span>
            </label>
            <input
              type="text"
              name="smtpUser"
          ...
          <div>
            <label className="block text-sm font-medium text-[#2D1B2E] mb-1">
              SMTP Password <span className="text-[#EE4275]">*</span>
            </label>
            <input
              type="text"
              name="smtpPassword"
          ...
          <div>
            <label className="block text-sm font-medium text-[#2D1B2E] mb-1">
              From Email <span className="text-[#EE4275]">*</span>
            </label>
            <input
              type="email"
              name="fromEmail"
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-[#2D1B2E] mb-1">
              Owner/Admin Email <span className="text-[#EE4275]">*</span>
            </label>
            <input
              type="email"
              name="ownerEmail"
        ...
        <div className="flex flex-wrap gap-3 mt-4 pt-4 border-t border-[#F7C7D3]/40">
          <button
            onClick={() => onSave(type)}
            disabled={saving}
            className="px-6 py-2 bg-gradient-to-r from-[#EE4275] to-[#FF6B9D] text-white rounded-xl hover:shadow-lg hover:shadow-[#EE4275]/25 transition-all disabled:opacity-50 flex items-center gap-2"
          >
            {saving ? (
              <><FaSpinner className="w-4 h-4 animate-spin" /> Saving...</>
            ) : (
          ...
          <button
            onClick={() => onTest(type)}
            disabled={isTesting}
            className="px-6 py-2 border border-[#EE4275] text-[#EE4275] rounded-xl hover:bg-[#EE4275] hover:text-white transition-colors disabled:opacity-50 flex items-center gap-2"
          >
            {isTesting ? (
              <><FaSpinner className="w-4 h-4 animate-spin" /> Sending Test...</>
            ) : (
    ...
    <div className="space-y-6 p-6 bg-[#FFF5F6] min-h-screen">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-[#2D1B2E] flex items-center gap-3">
          <FaMailBulk className="text-[#EE4275]" />
          Email Configuration
        </h2>
      ...
      {/* Info Box */}
      <div className="bg-[#FFF5F6] border border-[#EE4275]/20 rounded-xl p-4">
        <div className="flex items-start gap-3">
          <FaEnvelope className="w-5 h-5 text-[#EE4275] mt-0.5" />
          <div>
