...
// // app/components/WhyChooseUs.jsx - Updated
// 'use client';
...
// // State Card Component - Left Side
...
// // State Card Component - Right Side
...
//   if (loading) {
//     return (
//       <section className="py-10 md:py-14 lg:py-16 bg-gradient-to-b from-white via-[#FFF5F6]/30 to-white">
...
//   // ✅ Use centerImage from backend, fallback to default
...
//                     <Icon className="w-4.5 h-4.5 md:w-5 md:h-5 text-[#EE4275]" />
//                   </div>
...
//           {/* CENTER COLUMN - Image (from backend) */}
//           <motion.div
...
//                   {/* ✅ Dynamic center image from backend */}
//                   <img
//                     src={centerImage}
//                     alt="Beauty products"
...
//               return (
//                 <div key={badge.id || index} className="flex items-center gap-2">
//                   <Icon className="w-3.5 h-3.5 md:w-4 md:h-4 text-[#EE4275]" />
